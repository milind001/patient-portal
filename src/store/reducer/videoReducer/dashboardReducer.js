import * as dashboardActions from '../../action/videoAcion/dashboardActions';
...
const videoDashboadreducer = (state = initState, action) => {
  switch (action.type) {
...
export default videoDashboadreducer;
